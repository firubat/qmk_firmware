...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_QWERTY] = LAYOUT_4key(
     ...
     KC_LCTL,        KC_LGUI,    C(KC_SPC),     KC_LALT,   KC_BSPC,  LT(_NAV,KC_BSLS), LT(_NUM,KC_ENT), LT(_NUM,KC_ENT),  LT(_NAV,KC_SPC), KC_DEL,  KC_RALT,  KC_ESC,   C_S_T(KC_BSLS),KC_RCTL ),
    ...
    [_NUM] = LAYOUT_4key(
     _______,  KC_F1,      KC_F2,    KC_F3,      KC_F4,    KC_F5,    KC_EQL,                      KC_EQL,     KC_F6,     KC_F7,    KC_F8,   KC_F9,    KC_F10,  KC_F11,
     _______,  KC_QUES,    KC_1,     KC_2,       KC_3,     S(KC_P),  KC_PLUS,                      KC_PLUS,    KC_QUES,   KC_1,     KC_2,    KC_3,     S(KC_P),  KC_F12,
     _______,  KC_COMM,    KC_4,     KC_5,       KC_6,     KC_DOT,  KC_MINS,                      KC_MINS,    KC_COMM,   KC_4,     KC_5,    KC_6,     KC_DOT,  _______,
     _______,  KC_SLSH,    KC_7,     KC_8,       KC_9,     KC_0,      TG(_LED),                 TG(_NUM),     KC_SLSH,   KC_7,     KC_8,    KC_9,     KC_0,     _______,
     _______,  _______,    _______,        _______,       KC_BSPC,   KC_SPC,  _______,    _______,  _______, KC_DEL,          _______,        _______,  _______, _______),

    [_LED] = LAYOUT_4key(
     QK_BOOT,   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, RGB_MODE_TWINKLE,             XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, QK_BOOT,
     XXXXXXX, UG_SPDU, UG_SATU, UG_HUEU, UG_VALU, UG_NEXT, RGB_MODE_SWIRL,               XXXXXXX, XXXXXXX, BL_UP,  BL_STEP, XXXXXXX, XXXXXXX, XXXXXXX,
     XXXXXXX, UG_SPDD, UG_SATD, UG_HUED, UG_VALD, UG_PREV, RGB_MODE_RAINBOW,             XXXXXXX, XXXXXXX, BL_DOWN,  BL_BRTG, XXXXXXX, XXXXXXX, XXXXXXX,
     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, TG(_LED),                      TG(_LED), XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
     XXXXXXX, XXXXXXX, XXXXXXX,       XXXXXXX,    XXXXXXX, XXXXXXX, UG_TOGG,   BL_TOGG, XXXXXXX, XXXXXXX,    XXXXXXX,      XXXXXXX, XXXXXXX, XXXXXXX)
};
